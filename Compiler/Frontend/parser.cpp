...
namespace Frontend {
    Parser::Parser(Memory::Allocator& allocator, const DS::Vector<Token>& tokens) : allocator(allocator), tokens(tokens) {}

    ASTNode* Parser::generate_ast(Memory::Allocator& allocator, const DS::Vector<Token>& tokens) {
